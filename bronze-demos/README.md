# Foundation Bronze Tier - Demo Applications

This module contains demo applications showcasing the capabilities of the Foundation Bronze tier framework.

## About

Bronze tier demos are separated from the framework JAR to:
...
mvn exec:java -pl bronze-demos -Dexec.mainClass="org.jwellman.foundation.examples.SimpleDesktopDemo"
mvn exec:java -pl bronze-demos -Dexec.mainClass="org.jwellman.foundation.examples.MultiPanelDesktopDemo"
mvn exec:java -pl bronze-demos -Dexec.mainClass="org.jwellman.foundation.examples.BronzeTierShowcaseDemo"
mvn exec:java -pl bronze-demos -Dexec.mainClass="org.jwellman.foundation.examples.CustomDesktopProviderDemo"
mvn exec:java -pl bronze-demos -Dexec.mainClass="org.jwellman.foundation.examples.CustomSplashProviderDemo"
mvn exec:java -pl bronze-demos -Dexec.mainClass="org.jwellman.foundation.examples.LookAndFeelDemo"
```

### From IDE

Import the `bronze-demos` Maven module into your IDE and run any demo's `main()` method directly.
...
- **BronzeTierShowcaseDemo** - Comprehensive interactive showcase of Bronze features
...
- **foundation-bronze** - The Bronze tier framework
